 ...
 */
@Configuration
@EnableConfigurationProperties({EtcdCoreProperties.class})
public class EtcdAutoConfiguration {
	@Bean
	@ConditionalOnMissingBean
	public EtcdClient etcdClient() {
		return new EtcdClient(etcdCoreProperties().convertToURI().toArray(new URI[] {}));
	}

	@Bean
	@ConditionalOnMissingBean
	public EtcdCoreProperties etcdCoreProperties() {
		return new EtcdCoreProperties();
	}
